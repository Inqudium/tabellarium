 ...
 * Two echoes exist, on two kinds of thread, and this class answers both
 ...
 *   are not matched either (the README's "Cross-instance guards" names
 *   that gap and its future shape: a process-wide client-id registry
 *   this class would consult).
 ...
 */
internal class SelfLoggingGuard(
